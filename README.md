...
* Description:
* A simple library management system that allows users to add, list,  check out, check in, and delete books from a CSV database.
* Includes seeding of initial books if the database is empty.
 ...
 - The library data is stored in "library.csv" in the same directory as the executable.
 ...
 - 0.0 (Initial version):
 - Basic functionality for adding, listing, checking out, checking in,and deleting books.
